    ...
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100">
      ...
      <div className="hidden w-1/2 items-center justify-center lg:flex">
        <div className="text-center">
          ...
          <p className="mt-2 text-xl text-gray-600">We're so excited to see you again!</p>
        </div>
      </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <Input
                  ...
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm transition-all duration-200 focus:border-indigo-500 focus:ring-indigo-500 hover:border-indigo-400"
                />
              </div>
              <div>
              ...
              <div>
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white transition-all duration-200 hover:from-indigo-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Sign in
                </Button>
              </div>
      ...
      <div className="pointer-events-none fixed inset-0 flex items-center justify-center rotate-180" aria-hidden="true">
